...
> **项目地址**：https://github.com/xpader/wind-agent

基于 **Wind Framework** 的 AI Agent 协程应用项目。

## 简介

Wind Agent 是一个功能完整的 AI Agent 应用，集成了多个 LLM 平台、工具调用、技能系统和 MCP (Model Context Protocol) 支持。
...
```bash
# 克隆项目
git clone https://github.com/xpader/wind-agent.git
cd wind-agent
